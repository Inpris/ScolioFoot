...
public class AdminUpModel implements Serializable {
    Integer id, heightToTibialTuberosity, solids, footLength, first, second, third, fourth, fifth,
...
//    springSteel, adjustalift, shoesPink, shoesBlue, shoesBlack, smoSocks, toeWalking;
    Date dconsultation, disssue, insDate;
    String login, address, diagnosis, status, firstName, lastName, side, marks, notes, patronymic;
//            smo, modifications, allard, allardSide;

    public AdminUpModel() {
    }

    public AdminUpModel(String login, Integer id, String firstName, String lastName, String patronymic, String diagnosis, String side,
